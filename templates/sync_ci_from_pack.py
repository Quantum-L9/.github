#!/usr/bin/env python3
"""Seed .github surfaces + org-level files from pinned Quantum-L9/.github (org max-pull).

This is the REFERENCE consumer-side sync script. Consumer repos should copy this
to `scripts/sync_ci_from_pack.py` and invoke via `make sync-ci`.
...
It pulls:
  ...
  - Governance caller from templates/governance-caller.yml
...
def main() -> int:
    ...
    try:
        ...
        print("  ⊘ issue-templates directory not found, skipping")
